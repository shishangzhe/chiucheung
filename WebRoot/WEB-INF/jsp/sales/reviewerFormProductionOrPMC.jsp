		...
		<input id="flag" type="hidden" value="">
 			...
 			<table cellspacing="0" align="center" width="960px" cellpadding="1" rules="all" bordercolor="gray" border="1" style="table-layout: fixed;">
  			...
  			<tr style="height: 30px">
  				...
  				<td colspan="5" style="text-align:center;width: 30%">
	  				期望交布局图日：<input id="expectedLayoutDate" type="text" name="expectedLayoutDate" class="easyui-datebox" style="height: 27px" data-options="editable:false,readonly:true">
  				</td>
  				<td colspan="4" style="text-align:center;width: 24%">
  			...
  			<table cellspacing="0" align="center" width="960px" cellpadding="1" rules="all" bordercolor="gray" border="1" style="table-layout: fixed;">
	  			...
	  			<tr class="add" style="height: 30px">
	  				...
	  				<td colspan="2" style="text-align: center;">
	  					<input id="productName0" type="text" name="reviewerSubsidiaries[0].productName" style="width: 140px;height: 27px" class="easyui-textbox" data-options="readonly:true">
	  				</td>
	  				<td colspan="2" style="text-align: center;">
	  				...
	  				<td colspan="1" style="text-align: center;">
	  					<input id="quantity0" type="text" name="reviewerSubsidiaries[0].quantity" style="width: 35px;height: 27px" class="easyui-numberbox" data-options="readonly:true">
	  				</td>
	  				<td colspan="1" style="text-align: center;">
	  			...
	  			<tr style="height: 30px">
	  				...
	  				<td colspan="11" rowspan="3" style="text-align: center;">
	  					<input id="engRemark" type="text" class="easyui-textbox" name="engRemark" style="width: 96%;height: 87px" data-options="readonly:true,multiline:true">
	  				</td>
	  			...
	  			<tr style="height: 30px">
	  				...
	  				<td colspan="6" style="text-align: center;">
	  					最短时间：<input id="proExpectedShortestCompletionTime" type="text" name="proExpectedShortestCompletionTime" style="width: 40px;height: 27px" class="easyui-textbox">&nbsp;&nbsp;天&nbsp;&nbsp;
	  					最长时间：<input id="proExpectedLongestCompletionTime" type="text" name="proExpectedLongestCompletionTime" style="width: 40px;height: 27px" class="easyui-textbox">&nbsp;&nbsp;天
	  					<p:isPrivilege pid="ad" mid="adc">
	  						<a href="#" class="easyui-linkbutton" iconCls="icon-sum" onClick="openDialig2()" style="float: left;">项目评审工时计算</a>
  						</p:isPrivilege>
	  				</td>
	  				<td colspan="11" style="text-align: center;">
	  					预算安装人数和安装周期:                
	  					<input id="installPeopleNumber" type="text" name="installPeopleNumber" style="width: 50px;height: 27px" class="easyui-textbox">&nbsp;&nbsp;天/&nbsp;&nbsp;
	  					<input id="installPeriod" type="text" name="installPeriod" style="width: 35px;height: 27px" class="easyui-textbox">&nbsp;&nbsp;人
  				...
  				<tr style="height: 30px">
	  				<td colspan="13">
	  					有无特别加工手段（如设备或模具等费用）：
	  					<input class="radio" type="checkbox" name="isSpecialProcessing" value="false" checked="checked" onclick="showHiddenTextBox(this)">无&nbsp;&nbsp;
	  					<input class="radio" type="checkbox" name="isSpecialProcessing" value="true" onclick="showHiddenTextBox(this)">有&nbsp;&nbsp;
	  					<input type="text" name="specialProcessing" style="width: 380px;height: 27px" class="easyui-textbox" data-options="disabled:true,required:true">
	  				</td>
	  				<td colspan="4" style="text-align: center;">
	  					预计开工时间：
	  					<input id="proExpectedStartTime" type="text" name="proExpectedStartTime" class="easyui-datebox" data-options="editable:false" style="width: 92px;height: 27px">
	  				</td>
  				</tr>
  				<tr style="height: 30px">
	  				<td colspan="2" rowspan="3" style="text-align: center;">
	  				...
	  				<td colspan="11" rowspan="3" style="text-align: center;">
	  					<input id="proRemark" type="text" name="proRemark" class="easyui-textbox" style="width: 95%;height: 87px" data-options="multiline:true">
	  				</td>
	  				<td colspan="4" style="text-align: center;">
	  					填写人：<input id="proPreparer" type="text" name="proPreparer" style="width: 100px;height: 27px" class="easyui-textbox">
	  				</td>
	  			</tr>
	  			<tr style="height: 30px">
	  				<td colspan="4" style="text-align: center;">
