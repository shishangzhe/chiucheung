  			...
  			<table cellspacing="0" align="center" width="960px" cellpadding="1" rules="all" bordercolor="gray" border="1" style="table-layout: fixed;">
	  			...
	  			<tr height="30px">
	  				...
	  				<td colspan="3" style="text-align: center;">
	  					采购周期：<input id="purPeriod" type="text" name="purPeriod" style="width: 50px;height: 27px" class="easyui-textbox">&nbsp;&nbsp;天
	  				</td>
	  				<td colspan="5" style="text-align: center;">
	  					备注：<input id="purRemark" type="text" name="purRemark" style="width: 85%;height: 27px" class="easyui-textbox">
	  				</td>
	  				<td colspan="5" style="text-align: center;">
  				...
  				<tr style="height: 30px">
	  				<td colspan="13">
	  					...
	  					<input id="specialProcessing" type="text" name="specialProcessing" style="width: 360px;height: 27px" class="easyui-textbox" data-options="disabled:true,required:true">
	  				</td>
	  				<td colspan="4" style="text-align: center;">
	  					预计开工时间：
  				...
  				<tr style="height: 30px">
	  				...
	  				<td colspan="11" rowspan="3" style="text-align: center;">
	  					<input id="proRemark" type="text" name="proRemark" class="easyui-textbox" style="width: 100%;height: 87px;" data-options="multiline:true">
	  				</td>
	  				<td colspan="4" style="text-align: center;">
