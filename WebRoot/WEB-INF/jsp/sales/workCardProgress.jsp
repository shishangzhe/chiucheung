  ...
  <script type="text/javascript">
	  ...
	  $(function(){
			...
			var columns = [[
					        ...
					        {field:'deliveryPlace',title:'送货地点',width:200,align:'center',sortable:true},
					        {field:'expectedGiveDate',title:'预给日期',width:80,align:'center',sortable:true},
					        {field:'actualGiveDate',title:'实给日期',width:80,align:'center',sortable:true},
					        {field:'salState',title:'状态',width:80,align:'center',sortable:true},
					        {field:'salNgProblem',title:'NG问题原因',width:80,align:'center',sortable:true},
					    ]];
