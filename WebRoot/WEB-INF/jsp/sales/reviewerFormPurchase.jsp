 			...
 			<table cellspacing="0" align="center" width="960px" cellpadding="1" rules="all" bordercolor="gray" border="1" style="table-layout: fixed;">
  			...
  			<tr style="height: 30px">
  				...
  				<td colspan="12" style="text-align:left;">
	  				...
	  				&nbsp;&nbsp;其他：<input id="otherDelivery" type="text" style="width: 37%" name="otherDelivery" class="easyui-textbox" data-options="readonly:true">
  				</td>
  			...
  			<table cellspacing="0" align="center" width="960px" cellpadding="1" rules="all" bordercolor="gray" border="1" style="table-layout: fixed;">
  				...
  				<tr style="height: 30px">
	  				<td colspan="13">
	  					...
	  					<input type="text" name="specialProcessing" style="width: 380px;height: 27px" class="easyui-textbox" data-options="readonly:true,disabled:true,required:true">
	  				</td>
	  				<td colspan="4" style="text-align: center;">
	  					预计开工时间：
	  					<input id="proExpectedStartTime" type="text" name="proExpectedStartTime" class="easyui-datebox" data-options="editable:false,readonly:true" style="width: 92px;height: 27px">
	  				</td>
  				</tr>
  				<tr style="height: 30px">
	  				<td colspan="2" rowspan="3" style="text-align: center;">
	  				...
	  				<td colspan="11" rowspan="3" style="text-align: center;">
	  					<input id="proRemark" type="text" name="proRemark" class="easyui-textbox" style="width: 95%;height: 87px" data-options="multiline:true,readonly:true">
	  				</td>
	  				<td colspan="4" style="text-align: center;">
