  ...
  <script type="text/javascript">
	  ...
	  $(function(){
			...
			var columns = [[
					        ...
					        {field:'expectedDeliveryDate',title:'预交期',width:200,align:'center',sortable:true},
					        {field:'proPeriod',title:'做货周期',width:200,align:'center',sortable:true},
					        {field:'proReviewerDate',title:'生产评审时间',width:80,align:'center',sortable:true},
					        {field:'expectedWarehousingDate',title:'预交仓期',width:80,align:'center',sortable:true},
					        {field:'actualWarehousingDate',title:'实交仓期',width:80,align:'center',sortable:true},
					        {field:'proState',title:'状态',width:80,align:'center',sortable:true},
					        {field:'proNgProblem',title:'NG问题原因',width:80,align:'center',sortable:true},
					        {field:'proLeader',title:'负责人',width:80,align:'center',sortable:true},
					    ]];
