  ...
  <script type="text/javascript">
	  ...
	  $(function(){
			...
			var columns = [[
					        ...
					        {field:'expectedCarDate',title:'预出车日',width:200,align:'center',sortable:true},
					        {field:'actualCarDate',title:'实出车日',width:80,align:'center',sortable:true},
					        {field:'logRemark',title:'备注',width:80,align:'center',sortable:true},
					        {field:'engReleaseDataDate',title:'NG问题原因',width:80,align:'center',sortable:true},
					        {field:'zhuti',title:'负责人',width:80,align:'center',sortable:true},
					        {field:'other',title:'安装完成时间',width:80,align:'center',sortable:true},
					    ]];
