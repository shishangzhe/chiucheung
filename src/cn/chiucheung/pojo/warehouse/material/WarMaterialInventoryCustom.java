...
public class WarMaterialInventoryCustom extends WarMaterial implements Serializable{
	...
	public String getExistingQuantity() {
		if (getLowestWarehousingQuantity() != null && existingQuantity < getLowestWarehousingQuantity()){
